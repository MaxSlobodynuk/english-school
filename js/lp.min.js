var ssLanding = {
  closure: function () {
    ...
    for (let e = 0; e < t.length; e++) {
      let s = t[e],
        ...
        r = "https://{domain}.customer.smartsender.eu/lp/{target}"
          .replace("{domain}", a)
          .replace("{target}", d);
      "undefined" != typeof ssContext &&
        (r += "?context=" + ssLanding.encode(ssContext));
    ...
    function n(e) {
      window.addEventListener(
        "message",
        function (t) {
          t.data.hasOwnProperty("widget") &&
            e.setAttribute(
              "style",
              "height: " + t.data.widget.updates.height + "px"
            );
        },
        !1
      );
  ...
  create: function () {
    !1 === ssLanding.state && ssLanding.closure(), (ssLanding.state = !0);
  },
  state: !1,
  timeout: 2e3,
};
